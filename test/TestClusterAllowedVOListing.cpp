...
TEST(UnauthenticatedListClusterAllowedVOs){
	...
	auto listResp=httpGet(tc.getAPIServerURL()+"/"+currentAPIVersion+"/clusters/some-cluster/allowed_vos");
	...
	listResp=httpGet(tc.getAPIServerURL()+"/"+currentAPIVersion+"/clusters/some-cluster/allowed_vos?token=00112233-4455-6677-8899-aabbccddeeff");
	ENSURE_EQUAL(listResp.status,403,
