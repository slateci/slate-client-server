...
TEST(UnauthenticatedUpdateCluster){
	...
	auto resp=httpPut(tc.getAPIServerURL()+"/v1alpha1/clusters/Cluster_1234567890","stuff");
	...
	resp=httpPut(tc.getAPIServerURL()+"/v1alpha1/clusters/Cluster_1234567890?token=00112233-4455-6677-8899-aabbccddeeff","stuff");
	ENSURE_EQUAL(resp.status,403,
...
TEST(UpdateNonexistentCluster){
	...
	auto resp=httpPut(tc.getAPIServerURL()+"/v1alpha1/clusters/Cluster_1234567890?token="+adminKey,"stuff");
...
TEST(UpdateCluster){
	...
	auto updateResp=httpPut(tc.getAPIServerURL()+"/v1alpha1/clusters/"+clusterID+"?token="+adminKey,
...
TEST(MalformedUpdateRequests){
	...
	auto clusterUrl=tc.getAPIServerURL()+"/v1alpha1/clusters/"+clusterID+"?token="+adminKey;
...
TEST(UpdateClusterForVONotMemberOf){
	...
	auto userResp=httpPost(tc.getAPIServerURL()+"/v1alpha1/users?token="+adminKey,
	...
	auto updateResp=httpPut(tc.getAPIServerURL()+"/v1alpha1/clusters/"+clusterID+"?token="+userID,
				to_string(updateRequest));
