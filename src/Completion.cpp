...
_slate_completions(){
	...
	declare -A optionsWithArgs
	optionsWithArgs["--width"]=1
	optionsWithArgs["--api-endpoint"]=1
	optionsWithArgs["--api-endpoint-file"]=1
	optionsWithArgs["--credential-file"]=1
	optionsWithArgs["--output"]=1
	optionsWithArgs["--vo"]=1
	optionsWithArgs["--cluster"]=1
	optionsWithArgs["--kubeconfig"]=1
	optionsWithArgs["--conf"]=1
	optionsWithArgs["--from-literal"]=1
	optionsWithArgs["--from-file"]=1
	optionsWithArgs["--from-env-file"]=1
